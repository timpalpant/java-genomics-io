...
/**
 * Exception thrown when there is a (likely) unrecoverable formatting error in a
 * text Wig file
 * 
 * @author timpalpant
 *
...
public class WigFileFormatException extends RuntimeException {
  ...
  public WigFileFormatException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
