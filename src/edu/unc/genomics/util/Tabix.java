...
public class Tabix {
   ...
   * 
   * @param input
   *          the input interval file in ASCII text format
   * @param output
   *          the bgzipped output file
   * @throws IOException
   */
   ...
   * 
   * @param file
   *          the bgzipped, sorted file to index
   * @param conf
   *          the configuration to use (specifying the chr, start, stop cols)
