...
/**
 * Miscellaneous low-key file utilities such as guessing whether a file is ASCII
 * text, counting the number of lines in a file, or sorting a file analogous to
...
public class FileUtils {
  ...
  /**
   * Guess whether a file is ASCII text format, using a default threshold where
   * the number of non-ASCII characters found must be < 30%
   * 
   * @param p
   *          the file to determine if it is ASCII
  ...
  /**
   * Return the number of lines in an ASCII file, analogous to the UNIX "wc -l"
   * command
   * 
   * @param p
   *          the file to count lines
   ...
   * @param cmp
   *          compare two lines from the file according to this Comparator
   * @throws IOException
   */
