...
public class BedEntry extends ValuedInterval {
  ...
  /**
   * Parse a BedEntry from a line in a Bed file or return null, if the line
   * passed is a comment (#)
   * 
   * @param line
   *          a record in a Bed file
  ...
  public static BedEntry parse(String line) {
    ...
    if (start > stop) {
      throw new IntervalFileFormatException(
          "Invalid Bed entry has start > stop. Use strand column 6 (+/-) for Crick intervals");
    }
