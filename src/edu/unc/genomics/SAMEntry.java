...
/**
 * Wrapper for SAM-JDK's SAMRecord class that conforms to the specifications of
 * all other java-genomics-io classes and is a subclass of Interval
 * 
 * @author timpalpant
 *
 */
public class SAMEntry extends Interval implements Sequence {
   ...
   * @param tag
   * @param value
   * @see net.sf.samtools.SAMRecord#setAttribute(java.lang.String,
   *      java.lang.Object)
   */
   ...
   * @param tag
   * @param value
   * @see net.sf.samtools.SAMRecord#setUnsignedArrayAttribute(java.lang.String,
   *      java.lang.Object)
   */
