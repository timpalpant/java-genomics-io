...
/**
 * A class for writing data to Wiggle files in either fixedStep or variableStep
 * format
 * 
 * @author timpalpant
 *
...
public class WigFileWriter implements Closeable {
   ...
   * @param options
   *          if the file should be opened for appending, etc.
   * @throws IOException
   *           if a disk write error occurs
   */
   ...
   *          the Path to the Wig file
   * @param header
   *          the header for the new Wig file
   * @throws IOException
   *           if a disk write error occurs
   */
  ...
  /**
   * Add a new Contig of values to this Wig file The most compact format will
   * automatically be chosen (fixedStep/variableStep) based on sparsity and
   * layout and it will be written with the largest resolution that still
   * resolves all features in the data
   * 
   * @param contig
   *          the Contig of values to write to this Wig file
   */
  ...
  /**
   * Add a new Contig of values to this Wig file in fixedStep format Resolution
   * (step/span) will be automatically chosen so that the output is as compact
   * as possible while still resolving all features in the data.
   * 
   * @param contig
   *          the Contig of values to write to this Wig file
   ...
   * Resolution (span) will be automatically chosen so that the output is as
   * compact as possible while still resolving all features in the data.
   * 
   * @param contig
   *          the Contig of values to write to this Wig file
   * @return
