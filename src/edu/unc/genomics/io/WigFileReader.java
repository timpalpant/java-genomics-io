 ...
 * 
 * BigWig and regular ASCII-text Wig files may be used interchangeably as the
 * base class WigFile, and the correct format (Wig/BigWig) can be autodetected
 * by calling WigFile.autodetect()
 * 
 * @author timpalpant
 *
 */
public abstract class WigFileReader implements Closeable, Cloneable {
  ...
  /**
   * Autodetect whether a file is an ASCII-text Wig file or a BigWig file and
   * initialize it
   * 
   * @param p
   *          the file to initialize
   * @return a WigFile handle to p that is the appropriate subclass (BigWigFile
   *         or TextWigFile)
   * @throws IOException
   *           if an IO error occurs while trying to open the file
   * @throws WigFileFormatException
   *           if the format cannot be autodetected, or there is an illegal
   *           format in the file, or the file is not actually a Wig file
   */
  ...
  /**
   * Query for statistics about data in this Wig file corresponding to a
   * specific interval Without having to load the data into memory all at once
   * into a Contig
   * 
   * @param interval
   *          the Interval of data to query for
   * @return a SummaryStatistics object of the data in this wig file from
   *         interval
   * @throws IOException
   *           if a disk read error occurs
   * @throws WigFileException
  ...
  /**
   * @param chr
   *          the chromosome to get the start base pair for
  ...
  /**
   * @param chr
   *          the chromosome to get the stop base pair for
  ...
  /**
   * @param chr
   *          the chromosome to get the extents of
   * @return an Interval representing the first - last bases with data for this
   *         chromosome
   */
  ...
  /**
   * @param chr
   *          the chromosome to get the step of
  ...
  /**
   * @param chr
   *          the chromosome to get the span of
  ...
  /**
   * @return the standard deviation of all values for base pairs with data in
   *         this Wig file
   */
