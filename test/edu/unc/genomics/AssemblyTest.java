...
public class AssemblyTest {
  ...
  private String[] chromosomes = { "chrIV", "chrXV", "chrVII", "chrXII", "chrXVI", "chrXIII", "chrII", "chrXIV",
      "chrX", "chrXI", "chrV", "chrVIII", "chrIX", "chrIII", "chrVI", "chrI", "chrM", "2micron" };
  private int[] lengths = { 1531919, 1091289, 1090947, 1078175, 948062, 924429, 813178, 784333, 745742, 666454, 576869,
      562643, 439885, 316617, 270148, 230208, 85779, 6318 };
