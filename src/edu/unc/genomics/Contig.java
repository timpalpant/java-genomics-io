...
public class Contig extends Interval {
	...
	/**
	 * Get data from this Contig. If the Contig is not for this interval, then null is returned.
	 * If the specified start-stop are outside the Contig range,
	 * then the returned array will be padded with NaNs.
	 * @param i the interval to get data for
	 * @return the data for Interval i, or NaN where data is not available
	...
	/**
	 * Get data from this Contig. If the specified start-stop are outside the Contig range,
	 * then the returned array will be padded with NaNs.
	 * @param start the first base pair
	 * @param stop the last base pair
	 * @return the data from start-stop, or NaN where data is not available
	...
	/**
	 * Get a single value from this Contig, or NaN if there is no data for the base pair
	 ...
	 * @param interval an interval with a value to set
	 * @throws ContigException if the interval is not within this Contig
	 */
	...
	/**
	 * Set a certain range of this Contig to have a certain value
	 * @param interval the range to set
	 ...
	 * @param start the first base pair in an interval
	 * @param stop the last base pair in an interval
	 * @param value the value to set this range to
	 * @throws ContigException if start-stop is not within this Contig
	 */
	 ...
	 * @param bp the base pair to set
	 * @param value the value to set for bp
	 * @throws ContigException if bp is not within this Contig
	 */
	...
	/**
	 * Find the lowest base pair in this Contig that actually has a data value (not NaN)
	...
	/**
	 * Calculate the shortest span of values in this Contig
	 * A Wig file with this span will still resolve all of the data in this contig
	 * e.g. single base pair resolution = 1
	 * but if really the data are in 5bp windows, then should return 5 since 5 values will be duplicates
	 * and don't need to be written individually
